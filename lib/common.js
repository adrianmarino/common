...
function Logger() {
    return {
        ...
        info:   (message, args) => this.log("INFO - %s".repl(message), args),
        debug:  (message, args) => this.log("DEBUG - %s".repl(message), args),
        warn:   (message, args) => this.log("WARN - %s".repl(message), args),
        error:  (message, args) => this.log("INFO - %s".repl(message), args)
    };
}
